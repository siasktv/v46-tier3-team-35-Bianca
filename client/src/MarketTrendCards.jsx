    ...
    return(
        <div className="flex px-[20px] py-[18px] flex-col  gap-4 flex-1 rounded-xl border border-[#EAEAEA] bg-[#FFF]">
                ...
                <div className="flex items-center gap-3.5">
                    <img src={crypto.logo} alt="Bitcoin Logo"/>
                    <p className="font-semibold">{crypto.inicials}</p>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col justify-center items-start gap-2 flex-shrink-0">
                        <p className="text-black font-semibold text-lg">$ {crypto.price}</p>
                        <p className="text-[#808080] text-sm">{crypto.percentage}%</p>
                    </div>
                    <img src={chart}/>
                </div>
            </div>
