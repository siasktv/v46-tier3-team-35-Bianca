  ...
  return (
    ...
    >
      <div className="stat">
        ...
        <div className="stat-title" style={{display:"flex"}}>
          <FcNegativeDynamic style={{color:"red",marginRight:10, fontSize:22}}/> Low:{" "}
          {cryptoInfo.length === undefined &&
            cryptoInfo.market_data.low_24h.usd}
        </div>
        <div className="stat-title" style={{display:"flex"}}>
         <MdCurrencyExchange style={{marginRight:10, fontSize:22}}/> 24 hr price change:{" "}
          {cryptoInfo.length === undefined &&
      ...
      <div className="stat">
        <div className="stat-title" style={{display:"flex"}}>
         <FaRankingStar style={{marginRight:10, fontSize:22}}/> Coin Gecko rank:{" "}
          {cryptoInfo.length === undefined && cryptoInfo.coingecko_rank}{" "}
        </div>
        <div className="stat-title" style={{display:"flex"}}>
         <MdOutlineScoreboard style={{marginRight:10, fontSize:22}}/> Coin Gecko score:{" "}
          {cryptoInfo.length === undefined && cryptoInfo.community_score}
        </div>
        <div className="stat-title" style={{display:"flex"}}>
          <BsCashCoin style={{marginRight:10, fontSize:22}}/> Liquidity score:{" "}
